      MODULE INTREAD
        ...
        LOGICAL TRHF,TReadTUMat,TReadHF,tReadInCache,TQUASIEXCIT
        LOGICAL TSUMPROD,TCALCRHOPROD
        
        INTEGER NTAY(2),nHFit,NFROZEN,NTFROZEN,ORBORDER(8,2),iDFMethod
        INTEGER NRSTEPSMAX,IHFMETHOD,nSlotsInit,nMemInit,iDumpCacheFlag
