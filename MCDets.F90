...
!Particle number has grown too large - cull particles randomly
         ...
         call CullParticles(PL(nPL),.true.,iSeed,NoCulls,CullInfo,iCycle,iStep)
...
!Particle number has dropped too low - double all particles
         ...
         call CullParticles(PL(nPL),.false.,iSeed,NoCulls,CullInfo,iCycle,iStep)
      ENDIF
...
subroutine CullParticles(PL,tHighLow,iSeed,NoCulls,CullInfo,iCycle,iStep)
   use Calc , only : CullFactor
   Type(ParticleList) PL
