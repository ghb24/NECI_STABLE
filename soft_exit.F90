...
!=    heart yet).
!=  * Helper exit function: rather than trapping the value returned by
!=    test_SOFTEXIT and then tracing back through the calling stack and avoiding
!=    and unwanted calculations, provide a routine which, if test_SOFTEXIT is
!=    false, will just exit cleanly for you. 
