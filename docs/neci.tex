...
\subsection{Building the code}
	...
	\begin{lstlisting}[gobble=4]
		make [-j [n]] [neci.x|kneci.x|dneci.x|both|all]
	\end{lstlisting}
	...
	code (\code{dneci.x}) or both the normal and complex codes
	(\code{both}) or all of the above and various extra utilities
	(\code{all}).
