...
\usepackage{xcolor}
\usepackage{cool}
  \Style{DSymb=\mathrm{d}, DShorten=true}
  \Style{IntegrateDifferentialDSymb=\mathrm{d}}
  \Style{ISymb=\mathrm{i},
         ESymb=\mathrm{e}}
...
\newenvironment{todo}{\begin{todobox}\textbf{\underline{\textcolor{green}{TODO}}}}{\end{todobox}}
\newenvironment{bug}{\begin{bugbox}\textbf{\underline{\textcolor{red}{BUG}}}}{\end{bugbox}}
