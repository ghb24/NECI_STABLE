...
module quicksort
    ...
    interface sort
        module procedure sort_arr_int
        module procedure sort_arr_doub
    end interface

contains

    ! Array sort functions
    sort_arr_def(integer, sort_arr_int)
    sort_arr_def(real*8, sort_arr_doub)
