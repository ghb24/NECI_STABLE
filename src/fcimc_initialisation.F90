...
module fcimc_initialisation
    ...
    use CalcData, only: G_VMC_Seed, MemoryFacPart, TauFactor, StepsSftImag, &
                        ...
                        tInitializeCSF, S2Init, tReplicaEstimates, tDeathBeforeComms, &
                        pSinglesIn, pParallelIn, tSetInitFlagsBeforeDeath, &
                        tSetInitialRunRef, tEn2Init, tInitiatorSpace, i_space_in
