...
!This routine sorts into ASCENDING order of rho_jj - therefore rho_jj max = ExcitInfo(iMaxExcit,0) = 1
            CALL SORT3RN(iMaxExcit+1,ExcitInfo(0:iMaxExcit,0),ExcitInfo(0:iMaxExcit,1),ExcitInfo(0:iMaxExcit,2),HElement_t_size)
...
!Resort again - so that root is in element 0, then ordered by rho_jj in ascending order - probably not needed...
            CALL SORT3RN(TotExcits,ExcitInfo2(1:TotExcits,0),ExcitInfo2(1:TotExcits,1),ExcitInfo2(1:TotExcits,2),HElement_t_size)
...
!         WRITE(6,*) (LIST(I,1),I=1,NLIST)
         CALL SORT3RN(NLIST-1,LIST(1,0),LIST(1,1),LIST(1,2),HElement_t_size)
!         WRITE(6,*) (LIST(I,2),I=1,NLIST)
!         WRITE(6,*) (LIST(I,1),I=1,NLIST)
