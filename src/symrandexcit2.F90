...
!Choose whether to generate a double or single excitation. Prob of generating a double is given by pDoub.
            pDoubNew = pDoub
            IF (pDoubNew > 1.0_dp) CALL Stop_All(this_routine, "pDoub is greater than 1")
...
!        CALL PickElecPair(nI,Elec1Ind,Elec2Ind,SymProduct,iSpn,SumMl,-1)
    ...
    SUBROUTINE CreateExcitLattice2(nI, iLutnI, nJ, tParity, ExcitMat, pGen)
        ...
        DO
            ...
            ! Electon collisions
            IF (Elec1 == Hole1) CYCLE
            IF (Elec1 == Hole2) CYCLE
            IF (Elec2 == Hole1) CYCLE
            IF (Elec2 == Hole2) CYCLE
        ...
        IF (pGen >= 1.0_dp) call stop_all("CreateExcitLattice", "Should not have a pgen > 1")
