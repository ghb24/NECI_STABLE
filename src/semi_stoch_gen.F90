...
!             loc_source => CurrentDets
    ...
    subroutine generate_fci_core(ilut_list, space_size)
        ...
        use SystemData, only: nel, nbasis, BRR, nBasisMax, G1, tSpn, lms, tParity, SymRestrict, tSymSet, STOT
        ...
        if (.not. (tSpn .or. tGUGACore)) call stop_all(t_r, "To use the FCI-CORE option you must fix the total spin on &
