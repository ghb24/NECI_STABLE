        ...
        lp2: do while (.true.)
            ...
            IF (tUEG .or. tHub) THEN
                IF (IsMomentumAllowed(nJ)) THEN
                    ...
                    IF (iProcIndex == 0) write(25, *) excitcount, iExcit, iLutnJ(0)
                end if
            else if (tFixLz) THEN
                ...
                IF (IsMomAllowedDet(nJ)) THEN
                    excitcount = excitcount + 1
                    CALL EncodeBitDet(nJ, iLutnJ)
                    IF (iProcIndex == 0) write(25, *) excitcount, iExcit, nJ(:)
                end if
            ELSE
                excitcount = excitcount + 1
                CALL EncodeBitDet(nJ, iLutnJ)
...
!            ForbiddenIter=ForbiddenIter+1
            ...
            IF (tUEG .and. (.not. tLatticeGens)) THEN
            ...
            else if (tHub .and. (.not. tLatticeGens)) THEN
                kx = 0
                ky = 0
                kz = 0
                do j = 1, NEl
                ...
                IF (.not. (ktrial(1) == 0 .and. ktrial(2) == 0 .and. kz == 0)) THEN
                    CYCLE
                end if
            end if
