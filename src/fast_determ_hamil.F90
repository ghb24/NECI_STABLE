...
contains
    ...
    subroutine calc_determ_hamil_opt()
        ...
        call beta_dets%shared_alloc(nbeta_dets%ptr)
        call alpha_dets%shared_alloc(nalpha_dets%ptr)
        call beta_with_alpha%shared_alloc(nalpha_dets%ptr)
        ...
        call beta_beta%shared_alloc(nbeta_beta%ptr)
        ...
        call alpha_alpha%shared_alloc(nalpha_alpha%ptr)
