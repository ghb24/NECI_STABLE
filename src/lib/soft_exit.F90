...
module soft_exit
    ...
    use FciMCData, only: iter, CASMin, CASMax, tTruncSpace, tSinglePartPhase,&
                         ...
                         TotWalkers,tFlipHighPopSign,tPrintHighPop
...
contains
    ...
    subroutine ChangeVars(tSingBiasChange,tSoftExitFound,tWritePopsFound)
       ...
       logical :: tEof,any_deleted_file,tChangeParams(28),tSingBiasChange
...
#ifdef PARALLEL
           CALL MPI_BCast(tChangeParams,28,MPI_LOGICAL,i,MPI_COMM_WORLD,error)
#endif
