...
contains
    ...
    subroutine pick_orbitals_pure_uniform_singles(ilut, nI, excitInfo, pgen)
        ...
        call pchb_sampler%pick_orbitals_pure_uniform_singles(ilut, nI, excitInfo, pgen)
    end subroutine
    ...
    subroutine pick_orbitals_double_pchb(ilut, nI, excitInfo, pgen)
        ...
        type(ExcitationInformation_t), intent(out) :: excitInfo
        real(dp), intent(out) :: pgen
        call pchb_sampler%pick_orbitals_double_pchb(ilut, nI, excitInfo, pgen)
    end subroutine
    ...
    function calc_pgen_guga_pchb(ilutI, ilutJ, excitInfo) result(pgen)
        ...
        real(dp) :: pgen
        pgen = pchb_sampler%calc_pgen_guga_pchb(ilutI, ilutJ, excitInfo)
    end function
