...
!                 end if  
! 
!             end if  !Ind1_1e_ab.ne.Ind2_1e_ab
! 
...
!                     end if
! 
!                 end if  ! j a a i   and  a j i a terms
!             end if ! abba and baab terms
! 
!             ! aaaa and bbbb terms
...
! 
!                 end if 
!             end if  !Ind1_1e_aa.ne.Ind2_1e_aa
!         end if  !(i.ne.a).and.(j.ne.a)
! 
