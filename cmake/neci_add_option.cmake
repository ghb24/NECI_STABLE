...
macro( neci_add_option )
    ...
    if ( ${HAVE_${_p_FEATURE}} )
      ...
      foreach( pkg ${_p_REQUIRED_PACKAGES} )
        ...
        if( DEFINED ${PROJECT_NAME}_FIND_${pkg} AND NOT ${PROJECT_NAME}_FIND_${pkg})
          message( STATUS "Option ENABLE_${_p_FEATURE}: Searching for dependent package: ${pkg} explicitly skipped by toolchain file" )
        else()
          find_package( ${pkg} )
