...
if( ${_hostname} MATCHES "hydra[0-9]" )
    ...
    if( CMAKE_Fortran_COMPILER_ID STREQUAL "Intel" )
        message( STATUS "Changing RELEASE optimisation flags as Hydra is an inhomogeneous cluster" )
        ...
        set( CMAKE_Fortran_C_RELEASE "${CMAKE_C_FLAGS_RELEASE} -xavx" )
        set( CMAKE_Fortran_CXX_RELEASE "${CMAKE_CXX_FLAGS_RELEASE} -xavx" )
    endif()
