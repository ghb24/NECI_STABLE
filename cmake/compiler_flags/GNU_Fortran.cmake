...
set( ${PROJECT_NAME}_Fortran_WARNING_FLAGS "-Wall -Wextra -Wno-zerotrip -Wno-maybe-uninitialized -Wcharacter-truncation -Wuse-without-only -Wimplicit-procedure -Winteger-division -Wreal-q-constant ")
# Disable some warnings for legacy code. **These flags are always enabled for the respective files.**.
set( ${PROJECT_NAME}_Fortran_relaxed_WARNING_FLAGS "-Wno-unused -Wno-character-truncation -Wno-use-without-only -Wno-implicit-procedure -Wno-integer-division -Wno-real-q-constant -Wno-do-subscript -Wno-function-elimination")
