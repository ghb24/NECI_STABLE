module test_gasci_mod
    ...
    use orb_idx_mod, only: calc_spin_raw, sum, alpha, beta
    ...
    use disconnected_gasci, only: gen_disconnected => generate_nGAS_excitation, init_disconnected_GAS, clearGAS
...
contains
    ...
    subroutine test_pgen()
        ...
        use fast_gasci, only: gen_all_excits
