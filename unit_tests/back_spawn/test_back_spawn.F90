...
contains
    ...
    subroutine test_pick_occupied_orbital_single
        ...
        call pick_occupied_orbital_single(ilut, src, cc_index, run, pgen, orb)
    ...
    subroutine test_pick_occupied_orbital_hubbard
        ...
        print *, "projedet: ", projedet
        print *, "nBasis: ", nBasis
        call pick_occupied_orbital_hubbard(ilutI, run, pgen, orb)
    ...
    subroutine test_pick_occupied_orbital
        ...
        call pick_occupied_orbital(ilutI, src, ispn, run, pgen, cum_sum, orb)
    ...
    subroutine test_pick_second_occupied_orbital
        ...
        call pick_second_occupied_orbital(ilutI, cc_b, orb_a, ispn, run, &
            cpt, cum_sum, orb)
...
!         G1(4)%k = [0,0,0]
        ...
        call pick_occupied_orbital_ueg(ilutI, src, ispn, run, pgen, cum_sum, orb)
